...
The core *CureFuzz* is in the folder `./fuzz/cure_fuzz.py`.
...
Run `python enjoy_cure.py --env MountainCar-v0 --algo dqn --folder logs --load-best --guide ` to start fuzz testing.
