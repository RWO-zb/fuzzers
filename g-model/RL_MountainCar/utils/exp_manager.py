...
class ExperimentManager(object):
    ...
    def is_atari(env_id: str) -> bool:
        ...
        return entry_point is not None and "AtariEnv" in str(entry_point)
    ...
    def is_bullet(env_id: str) -> bool:
        ...
        if env_id not in gym.envs.registry:
            return False
        entry_point = gym.envs.registry[env_id].entry_point
        return entry_point is not None and "pybullet_envs" in str(entry_point)
    ...
    def is_robotics_env(env_id: str) -> bool:
        ...
        return "gym.envs.robotics" in entry_point_str or "panda_gym.envs" in entry_point_str
