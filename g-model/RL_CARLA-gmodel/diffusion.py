...
class Diffusion:
    ...
    def clip_samples(self, sample):
        # [Fix] Detach and convert to numpy safely
        ...
        # [Fix] CARLA Adaptation: Strictly clip to [-1, 1] for all dimensions
        # Removed MountainCar legacy logic
        sample = np.clip(sample, -1, 1)

        return sample

    def generate(self):
        # [Fix] Use torch.no_grad() for efficient inference
        with torch.no_grad():
